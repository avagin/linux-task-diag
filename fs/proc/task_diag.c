...
static const struct proc_ops task_diag_fops = {
	.proc_open		= task_diag_open,
	.proc_release		= task_diag_release,
	.proc_write		= task_diag_write,
	.proc_read		= task_diag_read,
};
